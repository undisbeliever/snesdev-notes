...
ADC addr, Y     | Absolute Indexed, X       | 79    | 3     | 4 | +1 if m=0, +1 if index crosses page boundary
...
AND addr, Y     | Absolute Indexed, X       | 39    | 3     | 4 | +1 if m=0, +1 if index crosses page boundary
...
CMP addr, Y     | Absolute Indexed, X       | D9    | 3     | 4 | +1 if m=0, +1 if index crosses page boundary
...
EOR addr, Y     | Absolute Indexed, X       | 59    | 3     | 4 | +1 if m=0, +1 if index crosses page boundary
...
LDA addr, Y     | Absolute Indexed, X       | B9    | 3     | 4 | +1 if m=0, +1 if index crosses page boundary
...
ORA addr, Y     | Absolute Indexed, X       | 19    | 3     | 4 | +1 if m=0, +1 if index crosses page boundary
...
SBC addr, Y     | Absolute Indexed, X       | F9    | 3     | 4 | +1 if m=0, +1 if index crosses page boundary
...
STA addr, Y     | Absolute Indexed, X       | 99    | 3     | 5 | +1 if m=0
